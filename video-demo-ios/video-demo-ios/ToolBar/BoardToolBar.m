...
@property (nonatomic,weak) WDGBoard *board;
           ...
           self.choosingToolIndex == choosingIndex){
            ...
            switch (choosingIndex) {
                case 0:
                {
                    ...
                    [self.board setToolWithType:[self isNewerThaniPhone6]?WDGBoardToolTypePen:WDGBoardToolTypeSingleSyncPen
...
//    [self uploadImage:image token:@"Bo7KgOB3js5PUaZkFO-45byYGEjUMANo9mDhCm8S:Me2PtEndlpB0N6F5ZtD32_zFx8U=:eyJzY29wZSI6ImRvZGV0b3AiLCJkZWFkbGluZSI6MTYxMDA1ODMyMTU3OX0="];
//    return;
...
//                                                         AccessKey:QiniuAK];
    ...
    [[AFHTTPSessionManager manager] GET:@"http://courseware.wilddogapp.com/uptoken" parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        if([responseObject isKindOfClass:[NSDictionary class]]){
            ...
            if(token.length){
                NSLog(@"token获取成功");
                [WS uploadImage:image token:token];
            }
        }
...
- (BOOL)isNewerThaniPhone6{
    ...
    //iPhone
    if ([deviceString isEqualToString:@"iPhone9,1"]||[deviceString isEqualToString:@"iPhone9,2"]||[deviceString isEqualToString:@"iPhone9,3"]||[deviceString isEqualToString:@"iPhone9,4"]||[deviceString isEqualToString:@"iPhone10,1"]||[deviceString isEqualToString:@"iPhone10,4"]||[deviceString isEqualToString:@"iPhone10,2"]||[deviceString isEqualToString:@"iPhone10,5"]||[deviceString isEqualToString:@"iPhone10,3"]||[deviceString isEqualToString:@"iPhone10,6"])   return YES;
    return NO;
}
